  ...
  acts: [
    {
      ...
      title: "第一階段：共同採購",
      intro:
        "你和一群關心食物來源的鄰居、幾位契作小農，決定籌組一個「生產者＋消費者」共同合作的合作社。最簡單的起步方式，是先從共同採購開始：集體下單、分擔行政與運載成本。",
      outro:
        "共同採購穩定運作幾個月後，大家開始討論：與其只是集體下單，能不能繞過中間商，直接把產地的東西送上餐桌？合作社準備進入下一階段。",
      events: [
        {
          id: "1-1",
    ...
    },
    {
      ...
      title: "第二階段：共同銷售與品牌",
      intro:
        "共同採購站穩腳步後，合作社開始有能力繞過中間商，建立自己的銷售通路與品牌，把「產地到餐桌」的距離真正縮短。規模變大了，決策也變得更複雜。",
      outro:
    ...
    },
    {
      ...
      intro:
        "銷售規模穩定成長，合作社開始有能力思考更大的可能：投入集體信貸、蓋自己的加工場，把初級農產品變成更有附加價值的商品，甚至打進更大的市場。",
      outro:
        "走到這一步，合作社已經不只是一群人共同買東西，而是一整條從產地到餐桌、由生產者與消費者共同擁有的價值鏈。它會走向什麼樣的未來，取決於這一路上做的每一個選擇。",
      events: [
        {
          id: "3-1",
          title: "要不要集資蓋一座共同加工場？",
