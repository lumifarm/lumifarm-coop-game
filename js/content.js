          ...
          options: [
            {
              ...
              feedback:
                "先墊錢確實讓事情動起來了，但你也隱約感覺到不對勁：原本該大家一起扛的風險，好像全壓在自己一個人身上。還好你先把歸還的方式講清楚了，這一步不能省。",
              unlock: ["founderrisk"],
            },
            {
            ...
            },
            {
              ...
              feedback:
                "合作社講究共識、股息又有限制，找錢本來就比一般公司慢。外部資源解了眼前的急，但條件跟期限，換成了別人說了算。",
        ...
        options: [
          {
            ...
            feedback:
              "你後來才明白：光是「大家都想要」，不代表大家都會真的出力。總有人想著「反正會有別人做」，理念再相近，這種心態也不會自己消失。",
            unlock: ["reasons"],
          },
          {
      ...
      events: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              effects: { democracy: 10, trust: 10, finance: -5 },
              feedback:
                "有了時間銀行，「你今天有沒有出力」不再是誰記在心裡的一筆帳，而是攤在陽光下、大家都算得清楚的點數。",
              unlock: ["reasons"],
            },
          ],
        },
          ...
          options: [
            {
              ...
              effects: { democracy: 10, trust: 5 },
              feedback:
                "你環顧四周才發現，社員本來就不是同一種人：有人全心投入，有人偶爾幫忙，有人這陣子忙得抽不開身。與其硬要大家長成同一個樣子，不如老實面對這些差異，各自找到合適的參與方式。",
        ...
        options: [
          {
            ...
            feedback:
              "你後來才想通：幹部之間有沒有共識，其實不是重點。真正的民主，是資訊有沒有公開給所有社員、決定是不是真的從基層長出來的。理監事自己講好，還差得遠。",
            unlock: ["laidlaw"],
          },
          {
      ...
      events: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              effects: { democracy: 10, trust: 5, finance: -10 },
              feedback:
                "外部顧問說得直白：與其靠一個能人撐著，不如讓大家真正成為這個組織的主人。這句話刺耳，卻也點出了問題的核心。",
              unlock: ["orgadvantage"],
            },
          ],
        },
          ...
          options: [
            {
              ...
              feedback:
                "你想起瑞士的 Migros 當年也面臨類似的抉擇：把決定權交還給全體社員，就算結果可能不合管理層的意。這一次，你選擇了同一條路。",
              unlock: ["migros"],
            },
            {
          ...
          options: [
            {
              ...
              feedback:
                "效率考量一旦走過頭，決定權就會不知不覺從全體社員手上溜走。增開社務會，就是把討論的時間點往前挪，讓大家在事情拍板之前，還來得及說話。",
            ...
            },
            {
              ...
              feedback:
                "業務效率確實提高了，但你隱約覺得哪裡不對——名義上合作社還是大家的，可真正在做決定的人，早就悄悄換了。",
              unlock: ["ownershipcontrol"],
            },
          ],
        },
          ...
          options: [
            {
              ...
              feedback:
                "你想起北美那家蔓越莓合作社 Ocean Spray，當年也是這樣一步步從共同生產走到自己加工，農民最後成了真正分享加工利潤的人。這筆錢讓大家捏了把冷汗，但你知道，這一步遲早要跨出去。",
              unlock: ["oceanspray"],
            },
            {
            ...
            },
            {
              ...
              feedback:
                "先蓋一條小規模試驗線，用比較小的風險，換一次驗證方向的機會——真的走不通，也還來得及回頭。",
              unlock: ["threestages"],
            },
          ],
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              effects: { democracy: 10, trust: 10, finance: 5 },
              feedback:
                "先當「預備社員」觀察一段時間，規模擴張跟治理穩定，好像也不是非得二選一不可。",
              unlock: ["coopmap"],
            },
          ],
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              feedback:
                "先讓雙方代表私下談談，談不攏才正式啟動調解——不是每次衝突都得一次拉到最正式的程序，卻也沒有把底線放掉。",
              unlock: ["laidlaw"],
            },
          ],
        },
          ...
          options: [
            {
              ...
              effects: { democracy: 10, trust: 10, finance: -5 },
              feedback:
                "你想起自己剛加入的時候，也是聽老社員一次次講當年怎麼開始的，才慢慢懂「為什麼」。這件事，該換你做給下一批人看了。",
              unlock: ["principles"],
            },
            {
              label: "假設新人自然而然會慢慢懂",
          ...
          options: [
            {
              ...
              effects: { democracy: 10, trust: 5, finance: -5 },
              feedback:
                "會議室裡有人小聲嘀咕「反正我快退休了」，但你知道，一旦大家開始只想著自己能領回多少，合作社離變成一般公司也不遠了。公積金留住，就是把「以後」留住。",
              unlock: ["degeneration"],
            },
            {
              ...
              feedback:
                "短期內大家都很開心，分紅入袋為安。但你隱約覺得，這是個回不了頭的開始——以後大概不會再有人願意為了合作社的未來，放棄眼前這一筆。",
              unlock: ["degeneration"],
            },
            {
              ...
              feedback:
                "帳面數字是好看了，但你也知道，那些被外包出去的廉價人力，本來就該是「社員共同承擔」的一部分。省下來的每一分錢，都是有人在別處吃虧換來的。",
              unlock: ["pseudocoop"],
            },
            {
      ...
      quiz: {
        ...
        options: [
          ...
          },
          {
            ...
            feedback:
              "短期內確實穩定，但你聽過太多合作社最後的樣子：理監事一路連任下去，年輕社員的聲音漸漸就沒人聽了。",
            unlock: [],
          },
          {
